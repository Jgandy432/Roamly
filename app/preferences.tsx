...
const ACCOMMODATION_MUST_HAVES = ['Pool', 'Gym', 'Kitchen', 'Free breakfast', 'Parking', 'Pet friendly', 'Balcony', 'Hot tub', 'Ocean view', 'Rooftop access', 'Fireplace', 'Washer and dryer', 'BBQ grill', 'Game room', 'Private pool', 'Beachfront', 'Mountain view'];
