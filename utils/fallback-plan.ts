...
export function generateFallbackPlan(trip: Trip): TripPlan {
  ...
  return {
    summary: {
      destination: dest,
      recommended_dates: '2026-11-14 to 2026-11-18',
      total_nights: 4,
    ...
    itinerary: [
      { day: 1, date: 'November 14 2026', title: 'Arrival & Beach Vibes', morning: { time: '11:00 AM', activity: 'Arrive & Check In', description: 'Settle into Villa Paraiso, quick grocery run', cost: '$30/group' }, afternoon: { time: '2:00 PM', activity: 'Beach Time', description: 'Relax at Playa Paraiso, rent beach beds', cost: '$15/person' }, evening: { time: '7:00 PM', activity: 'Welcome Dinner at Hartwood', description: 'Open-fire cooking, farm-to-table. Reserve 2 weeks ahead.', cost: '$45/person' } },
      { day: 2, date: 'November 15 2026', title: 'Cenote & Culture Day', morning: { time: '8:30 AM', activity: 'Cenote Sac Actun', description: 'Swim in crystal-clear underground cenote, arrive early', cost: '$25/person' }, afternoon: { time: '1:00 PM', activity: 'Tulum Ruins', description: 'Clifftop Mayan ruins overlooking the Caribbean', cost: '$5/person' }, evening: { time: '7:30 PM', activity: 'Dinner at Arca + Mezcal Bar', description: 'Modern Mexican tasting menu followed by cocktails', cost: '$60/person' } },
      { day: 3, date: 'November 16 2026', title: 'Adventure & Nightlife', morning: { time: '9:00 AM', activity: 'Jungle Bike Tour', description: 'Guided bike ride through the jungle to hidden cenotes', cost: '$35/person' }, afternoon: { time: '2:00 PM', activity: 'Pool Day + Spa', description: 'Relax at the villa. Optional massage sessions.', cost: '$50/person' }, evening: { time: '9:00 PM', activity: 'Papaya Playa Beach Party', description: 'Saturday night beach party under the stars', cost: '$30/person' } },
      { day: 4, date: 'November 17 2026', title: 'Last Day & Departure', morning: { time: '8:00 AM', activity: 'Sunrise Yoga on the Beach', description: 'Free community yoga session at Playa Paraiso', cost: 'Free' }, afternoon: { time: '12:00 PM', activity: 'Farewell Lunch at La Zebra', description: 'Beachfront brunch with live music', cost: '$35/person' }, evening: { time: '4:00 PM', activity: 'Departure', description: 'Head to Cancun airport (1.5 hr drive)', cost: '$25/person' } },
    ],
    restaurants: [
